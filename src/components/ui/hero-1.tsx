...
export function Hero({
  ...
  return (
    ...
    >
      ...
      {/* CTA */}
      {ctaLabel && (
        <div className="flex justify-center animate-fade-in opacity-0" style={{ animationFillMode: "forwards", animationDelay: "0.2s" }}>
          <a
            href={ctaHref}
            className={cn(buttonVariants({ variant: "default" }), "mt-[-20px] w-fit md:w-52 z-20 font-geist tracking-tighter text-center text-lg")}
          >
            {ctaLabel}
          </a>
        </div>
