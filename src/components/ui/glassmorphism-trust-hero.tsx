  ...
  return (
    <div className="relative w-full bg-zinc-950 text-white overflow-hidden font-sans">
      ...
      */}
      ...
      <div 
        className="absolute inset-0 z-0 bg-[url(https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1280&q=80)] bg-cover bg-center opacity-40 mix-blend-lighten"
        style={{
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
              We engineer scalable, high-performance web applications tailored to elevate your brand. Experience unparalleled speed, dynamic interactions, and aesthetic excellence with Xratch.
            </p>
            ...
            <div className="animate-fade-in delay-400 flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="group inline-flex items-center justify-center gap-2 rounded-full bg-white px-8 py-4 text-sm font-bold text-zinc-950 transition-all hover:scale-[1.02] hover:bg-zinc-200 active:scale-[0.98]"
              >
                Start Your Project
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <div className="text-3xl font-bold tracking-tight text-white">400+</div>
