  ...
  (
    {
      ...
      colors = {
        ...
        pageBg: "#09090b", // Adjusted for dark theme manually
        stageBg: "#09090b",
      },
    ...
    return (
      ...
      >
        ...
        <div className="fx-scroll">
          ...
          {/* End spacer */}
          <div className="fx-end h-64">
            {/* Keeping it short for smooth scroll to next sections instead of 'fin' padding */}
          </div>
        </div>
        ...
        <style jsx>{`
          ...
          .fx-fin { transform: rotate(90deg); color: #111; display: none; }
          ...
          @media (max-width: 900px) {
            ...
            /* Add visibility for small screens */
            .fx-right { display: none; } /* Hide right labels to save space */
          }
        `}</style>
      </div>
    );
